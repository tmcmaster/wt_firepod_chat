...
class MessagesChatScreen extends ConsumerStatefulWidget {
  ...
  factory MessagesChatScreen.fromState(GoRouterState? state) {
    if (state != null && state.extra != null) {
      final room = state.extra! as types.Room;
  ...
  @override
  ConsumerState<MessagesChatScreen> createState() => _ChatScreenState();
}

class _ChatScreenState extends ConsumerState<MessagesChatScreen> {
